...
> ループ開始: 最大 <max> 周 / 合格点 <threshold> / 時間上限 <max_wall> 分。1 周の目安は 3〜8 分、多くは 2〜4 周で収束します。途中で止める時は /yt-loop-cancel。合格に届かなくてもベスト版は必ず納品します。
...
`[YT-loop ENDED: ...]` を受けたら、その指示に従って 1 応答で完了させる:
